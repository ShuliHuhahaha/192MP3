...
ggplot(western.sum, aes(x = production_year)) +
  ...
  theme(axis.line = element_line(color = "black"),
    ...
    scale_color_discrete(name = "",
                         labels = c("Pure Western", "Short Western", "Total Western excluding Short")) 
```
...
datatable(movie.genre.1925.2014,
          ...
          caption = htmltools::tags$caption(
    style = 'text-align: center; font-size:150% ;',
    'Movie Genre Production in 1925 and 2014')
          )
```
...
[^1]: Github link: https://github.com/ShuliHuhahaha/192MP3
