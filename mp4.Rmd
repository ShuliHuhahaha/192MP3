...
```
```{r, echo=FALSE}
#Number of allwestern movies made between 1900 and 2015
...
Further, contents of Western movies have evolved considerably since they first came out. Both short and feature Western films had been produced with other genres in mind in the beginning of their history. For example: The first movie adaption of Zorro, [“the Mark of Zorro”](http://www.imdb.com/title/tt0032762/), falls under the genres Western, Adventure and Romance. As shown in the above figures, recent Western movies have been even more diverse in genres. While genres like Adventure and Romance remained popular in Western movies in the 21st century, Western movies in 2014 have crossed genres with Fantasy, Horror and Musical. This could explain why Western movies has recently increased in production amount. Assuming that the gradual decrease in Western movie production before 2000 was due to lost of audience interest in the Western genre, adding new mainstream genres into Western movies could help bring them back to the market.  
